...
ARG MINGW_W64_IMG=cgdoc/mingw-w64-multilib:posix-v1.8-el9
...
ARG CFLAGS="-m32 -march=i686 -mno-ms-bitfields -fstack-protector-strong -Wno-error=implicit-function-declaration -Wno-error=incompatible-pointer-types -Wno-error=int-conversion -Wno-error=return-mismatch"
...
ARG CFLAGS="-m64 -mno-ms-bitfields -fstack-protector-strong -Wno-error=implicit-function-declaration -Wno-error=incompatible-pointer-types -Wno-error=int-conversion -Wno-error=return-mismatch"
